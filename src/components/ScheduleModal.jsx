// ============================================
// Jovelin V3 - ScheduleModal Component
// ============================================
    ...
    try {
      ...
      if (accessToken) {
        try {
          ...
          alert('⚠️ Job scheduled in Jovelin but Google Calendar sync failed: ' + calErr.message);
        }
      }
            ...
            {weekDates.map((d, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{
                    color: isSelected(d) ? '#fff' : isToday(d) ? '#e8a33d' : '#e2e8f0',
        ...
        {selectedTech && selectedDate && (
          <div style={{ marginBottom: '16px' }}>
            <div style={{ 
              ...
              {hasGcalForTech && (
                <span style={{ 
                  fontSize: '9px', color: gcalLoading ? '#64748b' : '#e8a33d',
                  background: '#e8a33d10', padding: '2px 6px', borderRadius: '4px'
                }}>
            ...
            {gcalLoading ? (
              ...
              <div style={{ background: '#0f172a', borderRadius: '8px', overflow: 'hidden' }}>
                ...
                {/* Supabase jobs (already scheduled in Jovelin) */}
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <div>
                          ...
                          <div style={{ color: '#cbd5e1', fontSize: '11px' }}>
                            {j.issue?.slice(0, 40) || j.customer_address || 'Jovelin job'}
                          </div>
                        </div>
