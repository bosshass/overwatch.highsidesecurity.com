        ...
        {loading ? (
          ...
          <>
                  ...
                  {(availability[tech.id] || []).map(d => (
                    <button
                      ...
                      style={{
                        ...
                        outline: selectedDay?.date === d.date && selectedDay?.techId === tech.id ? '2px solid #e8a33d' : 'none',
                      }}>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                        {selectedDay.freeSlots.map((slot, i) => (
                          <button key={i} onClick={() => pickSlot(tech.id, selectedDay, slot)}
                            style={{
                              background: selectedSlot === slot ? '#e8a33d' : '#1e293b',
            ...
            <button onClick={confirm} disabled={!selectedSlot || saving}
              style={{
                width: '100%', background: selectedSlot ? '#e8a33d' : '#334155', border: 'none', borderRadius: 10,
