...
export const VALID_TRANSITIONS = {
  [JOB_STATUS.NEW]: [JOB_STATUS.NEEDS_DETAILS, JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.SCHEDULED, JOB_STATUS.NEEDS_ESTIMATE, JOB_STATUS.DEAD],
  [JOB_STATUS.NEEDS_DETAILS]: [JOB_STATUS.NEEDS_PARTS, JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.SCHEDULED, JOB_STATUS.NEEDS_ESTIMATE, JOB_STATUS.DEAD],
  [JOB_STATUS.NEEDS_PARTS]: [JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.SCHEDULED, JOB_STATUS.DEAD],
  [JOB_STATUS.PENDING_DECISION]: [JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.SCHEDULED, JOB_STATUS.NEEDS_PARTS, JOB_STATUS.NEEDS_ESTIMATE, JOB_STATUS.DEAD], // legacy — can move out only
  [JOB_STATUS.PENDING_MATERIALS]: [JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.SCHEDULED],
  [JOB_STATUS.READY_TO_SCHEDULE]: [JOB_STATUS.SCHEDULED, JOB_STATUS.NEEDS_DETAILS, JOB_STATUS.DEAD],
  [JOB_STATUS.RETURN_PENDING]: [JOB_STATUS.SCHEDULED, JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.DEAD],
  [JOB_STATUS.SCHEDULED]: [JOB_STATUS.COMPLETE, JOB_STATUS.RETURN_PENDING, JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.NEEDS_PARTS, JOB_STATUS.NEEDS_ESTIMATE],
  [JOB_STATUS.COMPLETE]: [JOB_STATUS.TO_BILL, JOB_STATUS.RETURN_PENDING, JOB_STATUS.NEEDS_ESTIMATE, JOB_STATUS.BILLED],
  [JOB_STATUS.TO_BILL]: [JOB_STATUS.BILLED, JOB_STATUS.NEEDS_ESTIMATE, JOB_STATUS.COMPLETE],
  [JOB_STATUS.BILLED]: [JOB_STATUS.ARCHIVED, JOB_STATUS.TO_BILL],
  [JOB_STATUS.NEEDS_ESTIMATE]: [JOB_STATUS.ESTIMATE_SENT, JOB_STATUS.DEAD],
  [JOB_STATUS.ESTIMATE_SENT]: [JOB_STATUS.WON, JOB_STATUS.LOST, JOB_STATUS.NEEDS_ESTIMATE],
  [JOB_STATUS.WON]: [JOB_STATUS.PENDING_MATERIALS, JOB_STATUS.READY_TO_SCHEDULE, JOB_STATUS.SCHEDULED],
  [JOB_STATUS.LOST]: [JOB_STATUS.ARCHIVED, JOB_STATUS.ESTIMATE_SENT],
  [JOB_STATUS.DEAD]: [JOB_STATUS.ARCHIVED, JOB_STATUS.NEW],
  [JOB_STATUS.ARCHIVED]: []
};
