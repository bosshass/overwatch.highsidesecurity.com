      ...
      <div style={S.filterRow}>
        {['all', 'Accepted', 'Pending', 'Closed'].map(f => (
          <button
            ...
            style={{
              ...S.pill,
              ...(qboFilter === f ? { background: '#e8a33d', color: '#0f1729', borderColor: '#e8a33d' } : {}),
            }}
          >
            {f === 'all' ? 'All QBO' : f}
          </button>
...
const S = {
  ...
  h1: { fontSize: 20, fontWeight: 700, margin: 0, color: '#e8a33d' },
  ...
  submitBtn: { padding: '6px 16px', border: 'none', borderRadius: 4, background: '#e8a33d', color: '#0f1729', cursor: 'pointer', fontSize: 13, fontWeight: 700 },
};
