...
export default function OpsHome({
  ...
  const COMMAND_CARDS = [
    ...
    {
      label: 'Estimates',
      sub: 'Contractor cost, markup, client price',
      icon: '🧾',
      accent: C.amber,
      path: '/estimates',
      show: isOperator,
    },
    {
      ...
      sub: 'QuickBooks + operations, one screen',
      icon: '💰',
      accent: C.green,
      path: '/overview',
      show: isOperator,
      ...
      <div style={{ position:'sticky', top:0, zIndex:10, background:'rgba(7,17,31,0.96)', backdropFilter:'blur(14px)', borderBottom:`1px solid ${C.line}`, padding:'14px 16px 12px' }}>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', gap:12, marginBottom:12 }}>
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            <div style={{ width:34, height:34, borderRadius:12, display:'grid', placeItems:'center', background:'#13233b', border:`1px solid #30445f`, color:'#9fd5ff', fontWeight:900, fontSize:13 }}>JV</div>
            <div>
              <div style={{ fontSize:19, fontWeight:700, lineHeight:1 }}>Jovelin</div>
